...
- To do this, test statistics are ranked (from biggest to smallest) and for set gene set a running sum is computed such that 
...
- Most popular option is Mummichog (li et alt. 2013).

![](PWA-4_Metabolomics-Slides_insertimage_16.png)

## Mummichog pathway mapping {.smaller}

- Ions are dividedvinto significant and non-significant groups.
...
- Les restrictive than Bonferroni adjustment which is a bound on the probability that **any one** of the observed enrichments could be due to random chance.
