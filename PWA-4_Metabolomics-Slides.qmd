...
![Statistics & Bioinformatics and Nutrition & Metabolomics groups @ UB ](images/Slides_insertimage_1.png)
...
![Characterization of disease attempted studying how this disrupts pathways](images/images/Slides_insertimage_.png)
...
![[A Metabolomics Worflow Example](https://doi.org/10.3390/metabo12040357)](images/Slides_insertimage_8.png){width=110%}


## From samples to *features* lists (2)

![Metabolomics Workflows in MetaboAnalyst 5.0](images/Slides_insertimage_3.png)
...
![An unordered list of metabolite IDs](images/Slides_insertimage_6.png){width=50%}
...
::: {.column width='60%'}
![Fold changes and AUC of metabolites whose concentrations were significantly increased in the patients with breast cancer compared to the healthy controls](images/Slides_insertimage_4.png)
...
![](images/Slides_insertimage_10.png)
...
![From Lists to Biology ](images/Slides_insertimage_11.png)
...
![Some common databases in Metabolomics ](images/Slides_insertimage_14.png)
...
![The  Human Metabolome Database ](images/Slides_insertimage_15.png)
...
![The Food Constituent Database ](images/Slides_insertimage_16.png)
...
![Kyoto Encyclopedia of Genes and Genomes ](images/Slides_insertimage_17.png)
...
![The Small Molecule Pathway Database (SMPDB) ](images/Slides_insertimage_18.png)
...
![Overview of MSEA's metabolite set libraries ](images/Slides_insertimage_20.png)

## Metamap clusters

![](Slides_insertimage_4.png)

## Chemical similarity clusters

![](Slides_insertimage_5.png)

## Chemical Ontologies

![](Slides_insertimage_3.png)
...
![P-value small, odds-ratio high: List is surprisingly enriched in Feature Set ](Slides_insertimage_12.png)


## Example 2: Non-enriched

![P-value high, odds-ratio around 1: List is not  enriched in Feature Set ](Slides_insertimage_11.png)
...
:::{.center}
![](Slides_insertimage_14.png){width=70%}
:::
...
- To do this, test statistics are ranked (from biggest to smallest) and for gene set a running sum is computed such that 
  - If a feature is in the  set add a certain quantity ($\sqrt{N_s/(N-N_s)}$)
  - If a feature is not in the set, substract a (small) quantity ($-\sqrt{(N-N_s)/N_s}$)
...
![ Mummichog redefines the work flow of untargeted metabolomics ](Slides_insertimage_18.png)
...
![In a test with a null and an alternative hypothesis there are 2 possible right decisions and two possible incorrect ones (Type I and Type II errors)](Slides_insertimage_19.png)

## Why Multiple testing matters

![](Slides_insertimage_20.png)

## TYpe I error not useful here

![](Slides_insertimage_21.png)

## How to deal with this issue?

![](Slides_insertimage_22.png)
...
![Common pathway analysis tools for metabolomics data.](Slides_insertimage_24.png)
...
![[Evaluation and comparison of bioinformatic tools for the enrichment analysis of metabolomics data](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-017-2006-0) ](Slides_insertimage_26.png)
:::

## The space of tools (in 2017)

![](Slides_insertimage_27.png)
